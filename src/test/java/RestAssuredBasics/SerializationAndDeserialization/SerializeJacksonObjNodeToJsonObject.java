...
public class SerializeJacksonObjNodeToJsonObject {
    ...
    @Test
    public void serializeJacksonObjNodeToJsonObject() throws JsonProcessingException {
        objMapper = new ObjectMapper();
        ObjectNode mainObj = objMapper.createObjectNode();
        ObjectNode nestedObj = objMapper.createObjectNode();
